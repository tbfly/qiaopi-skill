...
```
安装 qiaopi skill: https://github.com/your-username/qiaopi
```
...
```bash
git clone https://github.com/your-username/qiaopi.git /tmp/qiaopi
...
git clone https://github.com/your-username/qiaopi.git
```
